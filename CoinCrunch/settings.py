"""
Django settings for CoinCrunch project.
...
SECRET_KEY = 'django-insecure-2pay6$-(i-evgxyjh)-60&&2x*n(x+)j)c^(sf54vr401*tg^g'
...
WSGI_APPLICATION = 'CoinCrunch.wsgi.application'
